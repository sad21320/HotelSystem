...
namespace HotelSystem.Controllers
{
    public class RoomsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("RoomID,RoomNumber,RoomTypeID,Floor,Status,CreatedDate")] Room room)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("RoomID,RoomNumber,RoomTypeID,Floor,Status,CreatedDate")] Room room)
        {
            if (id != room.RoomID)
            {
                return NotFound();
